		...
		<tbody>
			...
			<tr class="text-c">	
				...
				<td class="td-manage">
					...
					<a title="编辑" href="javascript:;" onclick="admin_edit('用户编辑','admin-add.html','1','800','500')" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6df;</i>
					</a> 
					@if(auth() -> guard('admin')-> id() != $value -> id)
					<a title="删除" href="{{route('admin.user.del',['id' => $value -> id])}}" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6e2;</i>
					</a>
					@endif
				</td>
